...
退掉宿營之後，生活就是一整個輕鬆愜意，但是其實還是很多事情要做的。最近在期中地獄的開頭，認真體會到了不修通識課的壞處：**_「每節課都要期中！」_** 接下來連續三週每週都考一點，要求不多了，會過就行。

## 金盾獎

上禮拜六跟 [Each Chen](https://www.iach.cc) 去打金盾。發現學長的建議給的真的不錯。他說這是場通靈大賽。整張考卷下來我們確定有寫對的只有一題crypto，其他都是：_「應該是這個吧」「對，看起來挺合理的」_ 雖然寫的過程一整個在通靈，但是這樣的肯定不只我們這組。這次好像是刷掉一半的組別，希望會進決賽，~~進了還有金盾的衣服~~。其實這次不打完比賽不是零收穫，至少知道它很愛考reverse，之後可要來一天一題reverse，我想開始的時候開始d(`･∀･)b，最後附上一張紀念照。
